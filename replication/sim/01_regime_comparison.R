# =============================================================================
# replication/sim/01_regime_comparison.R   (formerly 04_regime_comparison.R)
# Birth-death alive-node fix folded in (was 06_bd_fix.R + splice_bdfix.R).
# Paths anchored at DM_ROOT. Output: $DM_ROOT/output/regime/dyn_cfg%02d.csv
...
#   CMP_MINI=1 CMP_CFG=1 DM_ROOT=. Rscript replication/sim/01_regime_comparison.R
# Array: one SLURM_ARRAY_TASK_ID per config (1..72). See replication/slurm/01_regime.sbatch.
...
outdir <- file.path(ROOT, "output", "regime")
