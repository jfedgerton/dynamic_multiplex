# =============================================================================
# replication/sim/03_coverage_valued.R   (formerly manuscript/17_coverage3_valued.R)
#
...
# the v2 sweep runs.
#
# Outputs per task (all under $DM_ROOT/output/coverage_valued/):
...
#
# Usage (mini test): COV_TASK=1 COV_MINI=1 DM_ROOT=. Rscript replication/sim/03_coverage_valued.R
# =============================================================================
...
outdir <- file.path(ROOT, "output", "coverage_valued")
