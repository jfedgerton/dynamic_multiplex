#!/bin/bash
#SBATCH --job-name=dm_cov2_main
#SBATCH --account=open
#SBATCH --partition=basic
#SBATCH --output=slurm/logs/13_cov2_main_%A_%a.out
#SBATCH --error=slurm/logs/13_cov2_main_%A_%a.err
...
COV_MODE=main COV_CORES=8 COV_OFFSET=${COV_OFFSET:-0} Rscript manuscript/13_coassign_ci_coverage.R
