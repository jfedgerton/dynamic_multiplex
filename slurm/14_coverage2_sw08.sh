#!/bin/bash
#SBATCH --job-name=dm_cov2sw08
#SBATCH --account=open
#SBATCH --partition=basic
#SBATCH --output=slurm/logs/14_cov2sw08_%A_%a.out
#SBATCH --error=slurm/logs/14_cov2sw08_%A_%a.err
#SBATCH --time=10:00:00
#SBATCH --mem=16G
#SBATCH --cpus-per-task=8
#SBATCH --array=1-594%64
...
COV_MODE=main COV_CORES=8 COV_OFFSET=${COV_OFFSET:-0} Rscript manuscript/14_coverage2_sw08.R
