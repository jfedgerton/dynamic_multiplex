# =============================================================================
# manuscript/16_coverage3_grid.R
#
...
#
# Usage (mini test): COV_TASK=1 COV_MINI=1 Rscript manuscript/16_coverage3_grid.R
# =============================================================================
...
outdir <- file.path("manuscript", "output", "coverage3_grid")
