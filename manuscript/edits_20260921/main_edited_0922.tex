...
\begin{figure}[t]
\centering
\resizebox{\textwidth}{!}{\input{figs/fig_decision_tree.tex}}
...
\begin{figure}
    ...
    %% [CLAUDE 2026-09-22] figure regenerated by post/10 (fig_order_recovery.pdf; 195 points, 6 methods x 4 networks); check the caption against the new panels.
