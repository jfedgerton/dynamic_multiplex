...
%% tikz + positioning (already in the preamble). Root at the top, questions
%% in diamonds, methods in shaded leaves, one line of evidence (mean joint
%% NMI, this method vs runner-up) under each leaf.
\begin{tikzpicture}[
  font=\small, >=stealth,
...
\node[ev, below=1mm of hung] {procedural guarantee only; never the most accurate (Table~2: 0.27 / 0.33 / 0.37 / 0.10)};
...
\node[ev, below=1mm of ms] {gradual switching 0.53 vs 0.27\\core/periphery 0.87 vs 0.46\\long series 0.69 vs 0.23; all splits/merges};
